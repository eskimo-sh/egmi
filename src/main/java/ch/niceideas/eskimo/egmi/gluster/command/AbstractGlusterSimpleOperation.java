...
public class AbstractGlusterSimpleOperation extends AbstractGlusterSimpleCommand<SimpleOperationResult>{
    ...
    public AbstractGlusterSimpleOperation(HttpClient httpClient, String command, String subCommand, String ... options) {
        super (httpClient);
    ...
    @Override
    protected final SimpleOperationResult buildResponse() {
