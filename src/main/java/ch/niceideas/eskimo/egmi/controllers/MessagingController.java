...
public class MessagingController extends AbstractInformationController<String, String> {
    ...
    @GetMapping("/get-lastline-messaging")
    @ResponseBody
    public String getLastlineMessaging() {
        return getLastlineElement(messagingService);
    }

    @GetMapping("/clear-messaging")
    @ResponseBody
    public String clearMessaging() {
        return clear(messagingService);
    }
}