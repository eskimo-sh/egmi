...
public class EgmiVolumeTest extends AbstractWebTest {
    ...
    public void setUp() throws Exception {
        ...
        loadScript("egmiVolume.js");

        js("volume = new egmi.Volume();");

        js("volume.initialize();");

        waitForElementIdInDOM("button-create-volume");
    }

    @Test
    public void testNominal() throws Exception {

        js("volume.showVolumeEdition();");

        js("$('#button-create-volume').prop('disabled', false);");
        js("$('#volume').val('test-volume');");
