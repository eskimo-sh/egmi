...
public class ResourceUtilsTest {
    ...
    public void testGetURL() throws Exception {
        ...
        assertNotNull(ResourceUtils.getURL("classpath:application-test.properties"));
    ...
    public void testGetFile() throws Exception {
        assertNotNull(ResourceUtils.getFile("classpath:application-test.properties"));
        assertTrue(ResourceUtils.getFile("classpath:application-test.properties").exists());
    }
}
