...
public class GlusterVolumeReplaceBrickTest extends AbstractCommandTest {
    ...
    public void testCommand() throws Exception {
        ...
        GlusterVolumeReplaceBrick command = new GlusterVolumeReplaceBrick(mockClient, "test_volume",
                new BrickId("192.168.10.71", "/var/lib/gluster/bricks/test1_1"),
        ...
        assertEquals("127.0.0.1:12345/command?command=volume&subcommand=replace-brick&options=test_volume%20192.168.10.71:/var/lib/gluster/bricks/test1_1%20192.168.10.72:/var/lib/gluster/bricks/test1_1%20commit%20force%20--mode=script", url.get());
    }
