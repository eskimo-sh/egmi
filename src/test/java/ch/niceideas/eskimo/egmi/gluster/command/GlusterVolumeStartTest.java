...
public class GlusterVolumeStartTest extends AbstractCommandTest {
    ...
    public void testCommand() throws Exception {
        ...
        assertEquals("127.0.0.1:12345/command?command=volume&subcommand=start&options=test_volume%20--mode=script", url.get());
    }
