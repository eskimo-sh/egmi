...
public class NodeDownTest extends AbstractProblemTest {
    ...
    public void testSolve() throws Exception {
        ...
        assertEquals("192.168.10.71:1234/command?command=volume&subcommand=replace-brick&options=spark_data%20192.168.10.72:/var/lib/gluster/volume_bricks/spark_data%20192.168.10.74:/var/lib/gluster/volume_bricks/spark_data%20commit%20force%20--mode=script", String.join("\n", urls));
    }
}
